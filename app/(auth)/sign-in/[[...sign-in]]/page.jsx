      ...
      <div className="flex flex-col justify-center items-center mx-auto my-8 max-w-md w-full">
        <SignIn.Step name="start" className="w-full p-4 rounded-lg">
          <div className="text-start pb-3">
            <h1 className="text-primary font-semibold text-2xl">Sign In to Your Account</h1>
            <p className="pt-2">No account? <Link href={"/sign-up"} className="underline font-medium">Create one</Link>
            </p>
          </div>
          ...
          <Clerk.Field name="identifier">
            ...
            <Clerk.Input
              className="w-full my-1 p-2 border-2 border-primary rounded-lg bg-muted placeholder:text-primary placeholder:opacity-70 focus:border-primary focus:outline-none"
