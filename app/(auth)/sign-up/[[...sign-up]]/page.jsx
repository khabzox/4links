      ...
      <div className="flex flex-col justify-center items-center mx-auto my-8 max-w-md w-full">
        <SignUp.Step name="start" className="w-full p-4 rounded-lg">
          <div className="text-start pb-3">
            <h1 className="text-primary text-2xl font-semibold">Sign In to Your Account</h1>
            <p className="pt-1">
          ...
          <Clerk.Connection name="google" className="flex justify-center items-center font-medium gap-3 my-4 w-full py-2 text-center border-2 border-primary rounded-lg hover:bg-gray-200/90">
            <GoogleIcon height="18" width="22" /> Continue with Google
          </Clerk.Connection>

          <div className="flex justify-center items-center my-2">
            <div className="border-2 rounded-xl border-primary text-primary grow"></div>
            <div className="px-5">or</div>
            <div className="border-2 rounded-xl border-primary text-primaryy grow"></div>
          </div>

          <Clerk.Field name="emailAddress" className="mb-4">
            <Clerk.Label>Email:</Clerk.Label>
            <Clerk.Input
              className="w-full my-1 p-2 border-2 border-primary text-primary rounded-lg bg-muted placeholder:text-primary placeholder:opacity-70 focus:border-prtext-primary focus:outline-none"
          ...
          <Clerk.Field name="password">
            ...
            <div className="relative">
              <Clerk.Input
                ...
                className="w-full my-1 p-2 border-2 border-primary text-primary rounded-lg bg-muted placeholder:text-primary placeholder:opacity-70 focus:border-prtext-primary focus:outline-none pr-10" // Add padding to right for icon
        ...
        <SignUp.Step name="verifications">
          <SignUp.Strategy name="email_code">
            ...
            <Clerk.Field name="code" className="mt-5">
              ...
              <Clerk.Input
                className="w-full my-1 p-2 border-2 border-primary rounded-lg bg-muted placeholder:text-primary placeholder:opacity-70 focus:border-prtext-primary focus:outline-none"
            ...
            <SignUp.Action submit
              className="flex justify-center items-center gap-2 w-full mt-5 py-2 bg-primary text-muted rounded-lg hover:opacity-95"
